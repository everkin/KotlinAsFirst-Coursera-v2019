...
fun seconds(hours: Int, minutes: Int, seconds: Int): Int =
    (hours * minutesInHour + minutes) * secondsInMinute + seconds
 ...
 */
const val metersInVershok = 4.445
const val centimetersInArshin = 16 * metersInVershok
const val centimetersInSagene = 3 * centimetersInArshin
const val centimetersInMeter = 100

fun lengthInMeters(sagenes: Int, arshins: Int, vershoks: Int): Double =
    (sagenes * centimetersInSagene + arshins * centimetersInArshin + vershoks * metersInVershok) / centimetersInMeter
...
fun travelMinutes(hoursDepart: Int, minutesDepart: Int, hoursArrive: Int, minutesArrive: Int): Int =
    (hoursArrive - hoursDepart) * minutesInHour + minutesArrive - minutesDepart
